...
type Validator interface {
	...
	ValidateCommonJSONBody(c *fiber.Ctx, data any) error
	ValidateCommonParam(c *fiber.Ctx, data any) error
	ValidateCommonFormBody(c *fiber.Ctx, data any) error
	ValidateImageFiles(files []*multipart.FileHeader, maxFileSize int64) error
	ValidateCommonQueryParam(c *fiber.Ctx, data any) error
}
...
func (v *validator) ValidateCommonJSONBody(c *fiber.Ctx, data any) error {
...
func (v *validator) ValidateCommonParam(c *fiber.Ctx, data any) error {
...
func (v *validator) ValidateCommonFormBody(c *fiber.Ctx, req any) error {
...
func (v *validator) ValidateCommonQueryParam(c *fiber.Ctx, req any) error {
	...
	if paginationField.IsValid() {
		pagination := paginationField.Addr().Interface().(*repository.PaginationQuery)
